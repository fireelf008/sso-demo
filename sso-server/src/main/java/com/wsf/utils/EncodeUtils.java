...
public class EncodeUtils {
     ...
     * @return
     */
    public static String aesEncoder(String content, String secretKey) {
        try {
     ...
     * @return
     */
    public static String aesDecoder(String content, String secretKey) {
        try {
            //1.构造密钥生成器，指定为AES算法,不区分大小写
            KeyGenerator keygen = KeyGenerator.getInstance("AES");
            //2.根据ecnodeRules规则初始化密钥生成器
    ...
    public static String urlEncoder(String content, String encode) {
        try {
            String encodeStr = URLEncoder.encode(content, encode);
            return encodeStr;
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
    ...
    public static String urlDecoder(String content, String encode){
        try {
            String decodeStr = URLDecoder.decode(content, encode);
            return decodeStr;
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
